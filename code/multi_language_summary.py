...
def get_user_language_preferences():
    ...
    # Simplified list of common languages with their codes
    language_options = {
        "1": {"name": "English", "code": "en"},
        "2": {"name": "Spanish", "code": "es"},
        "3": {"name": "French", "code": "fr"},
        "4": {"name": "German", "code": "de"},
        "5": {"name": "Chinese", "code": "zh-CN"},
        "6": {"name": "Japanese", "code": "ja"},
    ...
    # Get source language
    while True:
        source_choice = input("\nWhat language is the audio in? (enter number): ").strip()
        if source_choice in language_options:
            source_language = language_options[source_choice]
            break
        print("Invalid choice. Please try again.")
    
    # Get target language
    while True:
        target_choice = input("\nWhat language would you like the output in? (enter number): ").strip()
        if target_choice in language_options:
            target_language = language_options[target_choice]
            break
        print("Invalid choice. Please try again.")
