...
def send_meeting_summary(report_path, recipients, smtp_server, smtp_port, sender_email, sender_password):
    ...
    try:
        ...
        transcript_path = report_data.get("output_files").get("transcript", "")
        action_items_path = report_data.get("output_files").get("action_items", "")
        summary_path = report_data.get("output_files").get("summary", "")
